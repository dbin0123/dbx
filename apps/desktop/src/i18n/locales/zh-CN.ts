...
export default withEnglishFallback({
  ...
  diff: {
    ...
    similarity: "相似度",
    confirmRename: "确认重命名",
    renameApplied: "重命名已应用",
    ignore: "忽略",
    riskLevel: {
      safe: "安全 — 无兼容性警告",
      caution: "注意 — {count} 条兼容性警告",
      dangerous: "危险 — {count} 条兼容性警告，需要额外确认",
    },
    deployMode: "部署 SQL",
    rollbackMode: "回滚 SQL",
    ...
    fieldMapping: {
      title: "字段类型映射",
      description: "自定义源数据库类型到目标数据库类型的映射规则",
      sourceType: "源类型",
      targetType: "目标类型",
      paramStrategy: "参数策略",
      strategyPreserve: "保留",
      ...
      sameTypeHint: "源和目标是相同的数据库类型，无需映射",
      preset: "预设映射",
      selectPreset: "选择预设...",
  ...
  schemaDiff: {
    ...
    options: {
      ...
      detectRenames: "检测重命名（Levenshtein 相似度）",
      renameThreshold: "重命名相似度阈值",
      enableRollback: "生成回滚 SQL",
      batchPatterns: "批量命名模式",
      sourceDialect: "源方言（自动检测）",
      targetDialect: "目标方言（自动检测）",
      compatibilityThreshold: "跨方言兼容性阈值",
      advancedSection: "高级选项",
      batchSection: "批量与脚本选项",
    },
  },
  dataCompare: {
    title: "比较数据",
    ...
    degradationLevelFull: "完整比对（所有行）",
    degradationLevelSample: "采样（仅预览）",
    degradationLevelSkipWithRisk: "跳过（有风险警告）",
    samplingStrategy: "采样策略",
    samplingStrategyRandom: "随机采样",
    samplingStrategyFirstRows: "首行采样",
    samplingStrategyHybrid: "混合（随机 + 极值）",
    maxRowsThreshold: "降级前最大行数",
