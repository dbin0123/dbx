...
export default withEnglishFallback({
  ...
  diff: {
    ...
    fieldMapping: {
      title: "Mappaggio tipi campo",
      description: "Personalizza la mappatura dei tipi di dati sorgente ai tipi di destinazione quando i database differiscono",
      sourceType: "Tipo sorgente",
      targetType: "Tipo destinazione",
      paramStrategy: "Parametri",
      strategyPreserve: "Mantieni",
      strategyStrip: "Rimuovi",
      strategyCustom: "Personalizza",
      customParamsPlaceholder: "es. (200) o (10,2)",
      addMapping: "Aggiungi mappatura",
      removeMapping: "Rimuovi",
      noMappings: "Nessuna mappatura tipo campo definita",
      sameTypeHint: "Sorgente e destinazione sono lo stesso tipo di database — nessuna mappatura necessaria",
      preset: "Mappature predefinite",
      selectPreset: "Seleziona predefinito...",
      openFieldMapping: "Mappatura Tipo Campo",
      import: "Importa",
      export: "Esporta",
      importSuccess: "Importato con successo",
      importError: "Importazione fallita: il file non è un JSON di mappatura del tipo di campo valido",
      done: "Fatto",
    },
    fieldMappingToggle: "Mappaggio tipi campo",
  },
  schemaDiff: {
