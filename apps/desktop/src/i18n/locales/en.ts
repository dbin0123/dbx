export default {
  ...
  diff: {
    ...
    renameCandidates: "Rename Candidates",
    ...
    ignore: "Ignore",
    riskLevel: {
      safe: "Safe — no compatibility warnings",
      caution: "Caution — {count} compatibility warning(s)",
      dangerous: "Dangerous — {count} compatibility warning(s), requires extra confirmation",
    },
    ...
    fieldMapping: {
      ...
      paramStrategy: "Params",
      strategyPreserve: "Keep",
      strategyStrip: "Drop",
      strategyCustom: "Custom",
      customParamsPlaceholder: "e.g. (200) or (10,2)",
  ...
  schemaDiff: {
    ...
    options: {
      ...
      detectRenames: "Detect renames (Levenshtein similarity)",
      renameThreshold: "Rename similarity threshold",
      enableRollback: "Generate rollback SQL",
      batchPatterns: "Batch naming patterns",
      sourceDialect: "Source dialect (auto-detect)",
      targetDialect: "Target dialect (auto-detect)",
      compatibilityThreshold: "Cross-dialect compatibility threshold",
      advancedSection: "Advanced Options",
      batchSection: "Batch & Script Options",
    },
  },
  tag: {
    ...
    importSuccess: "Tags imported successfully",
    importFailed: "Failed to import tags",
    whitelist: "Tag Inheritance Whitelist",
    whitelistEdit: "Edit Whitelist",
    whitelistUpdated: "Whitelist updated",
    noTags: "No tags configured",
    confirmDelete: 'Delete tag "{key}"?',
    deleted: "Tag deleted",
    saved: "Tag saved",
  },
  impact: {
    title: "Online Impact Assessment",
    overallRisk: "Overall Risk",
    ddlRiskLevel: "DDL Risk Level",
    estimatedDuration: "Est. Duration",
    recommendedStrategy: "Recommended Strategy",
    requiresMaintenanceWindow: "Requires Maintenance Window",
    ...
    batch: "Batch",
    strategyOnline: "Execute directly on source database",
    strategyLazy: "Defer execution to off-peak window",
    strategyOffline: "Requires maintenance window and downtime",
    strategyBatch: "Execute in batches with progress tracking",
  },
  rollbackComparison: {
    title: "Rollback Comparison",
    forwardSql: "Forward SQL",
    rollbackSql: "Rollback SQL",
    noDifferences: "Forward and Rollback SQL show no differences",
    syncScroll: "Sync Scroll",
    addedLines: "Added",
    removedLines: "Removed",
    modifiedLines: "Modified",
    noRollbackAvailable: "No rollback SQL available for this diff",
  },
  strictTag: {
    title: "Strict Tag Violations",
    noViolations: "No tag violations detected",
    fileName: "File",
    lineNumber: "Line",
    tagName: "Tag Name",
    ...
    ignore: "Ignore",
    violationsFound: "{count} tag violation(s) found",
    blockingExecution: "Execution blocked due to strict tag violations",
    fixAndRetry: "Please fix the violations and retry",
  },
  conflictMatrix: {
    ...
    requiresManualIntervention: "Requires Manual Intervention",
    resolveWithSource: "Use Source",
    resolveWithTarget: "Use Target",
    resolved: "Conflict resolved",
  },
  privilegeMatrix: {
    title: "Permission Changes",
    objectName: "Object Name",
    privilegeType: "Permission Type",
    sourceStatus: "Source",
    targetStatus: "Target",
    granted: "Granted",
    revoked: "Revoked",
  ...
  osc: {
    title: "Online Schema Change Status",
    toolType: "Tool",
    tableName: "Table",
    status: "Status",
    progress: "Progress",
    ...
    failed: "Failed",
    postponed: "Postponed",
    noActiveOsc: "No active OSC operations",
    ghost: "gh-ost",
    ptosc: "pt-osc",
  },
  rebase: {
    title: "Baseline Rebase",
    driftReport: "Drift Report",
    currentBaseline: "Current Baseline",
    newBaseline: "New Baseline",
    overwriteBaseline: "Overwrite Baseline",
    skipObject: "Skip Object",
    conflicts: "Conflicts",
    autoResolved: "Auto-Resolved",
    requiresManual: "Requires Manual Resolution",
    rebaseExecuted: "Rebase executed successfully",
    rebaseFailed: "Rebase failed",
    confirmOverwrite: "Overwrite baseline with current target state?",
  ...
  configDrift: {
    ...
    noDrift: "No configuration drift detected",
    driftFound: "{count} drift(s) found",
    acknowledgeSuccess: "Drift alert acknowledged",
    checksum: "Checksum",
    mismatchedFields: "Mismatched Fields",
  },
  dataCompare: {
    title: "Compare Data",
    ...
    degradationLevelFull: "Full compare (all rows)",
    degradationLevelSample: "Sample (preview only)",
    degradationLevelSkipWithRisk: "Skip with risk warning",
    samplingStrategy: "Sampling strategy",
    samplingStrategyRandom: "Random sample",
    samplingStrategyFirstRows: "First rows",
    samplingStrategyHybrid: "Hybrid (random + extreme values)",
    maxRowsThreshold: "Max rows before degradation",
