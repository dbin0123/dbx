...
export default withEnglishFallback({
  ...
  diff: {
    ...
    similarity: "相似度",
    confirmRename: "確認重命名",
    renameApplied: "重命名已應用",
    ignore: "忽略",
    riskLevel: {
      safe: "安全 — 無兼容性警告",
      caution: "注意 — {count} 條兼容性警告",
      dangerous: "危險 — {count} 條兼容性警告，需要額外確認",
    },
    deployMode: "部署 SQL",
    rollbackMode: "回滾 SQL",
    renameCount: "{count} 次重命名",
    fieldMapping: {
      title: "欄位類型映射",
      description: "自訂來源資料庫類型到目標資料庫類型的映射規則",
      sourceType: "來源類型",
      targetType: "目標類型",
      paramStrategy: "參數策略",
      strategyPreserve: "保留",
      strategyStrip: "丟棄",
      strategyCustom: "自訂",
      customParamsPlaceholder: "如 (200) 或 (10,2)",
      addMapping: "新增映射",
      removeMapping: "刪除",
      noMappings: "未定義自訂欄位類型映射",
      sameTypeHint: "來源和目標是相同的資料庫類型，無需映射",
      preset: "預設映射",
      selectPreset: "選擇預設...",
    },
    fieldMappingToggle: "欄位類型映射",
  },
  schemaDiff: {
    optionsTitle: "比較選項",
    selectConfig: "選擇配置",
    ...
    options: {
      ...
      detectRenames: "檢測重命名（Levenshtein 相似度）",
      renameThreshold: "重命名相似度閾值",
      enableRollback: "生成回滾 SQL",
      batchPatterns: "批量命名模式",
      sourceDialect: "源方言（自動檢測）",
      targetDialect: "目標方言（自動檢測）",
      compatibilityThreshold: "跨方言兼容性閾值",
      advancedSection: "高級選項",
      batchSection: "批量與腳本選項",
    },
  },
  dataCompare: {
    title: "比較資料",
    ...
    degradationLevel: "降級級別",
    degradationLevelFull: "完整比對（所有行）",
    degradationLevelSample: "採樣（僅預覽）",
    degradationLevelSkipWithRisk: "跳過（有風險警告）",
    samplingStrategy: "採樣策略",
    samplingStrategyRandom: "隨機採樣",
    samplingStrategyFirstRows: "首行採樣",
    samplingStrategyHybrid: "混合（隨機 + 極值）",
    maxRowsThreshold: "降級前最大行數",
    confidenceThreshold: "置信度閾值",
  },
  settings: {
    title: "設定",
    editorTab: "編輯器",
