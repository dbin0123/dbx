...
export default withEnglishFallback({
  ...
  diff: {
    ...
    fieldMapping: {
      ...
      description: "Personalize como os tipos de dados de origem são mapeados para tipos de destino quando os bancos de dados diferem",
      sourceType: "Tipo origem",
      targetType: "Tipo destino",
      paramStrategy: "Parâmetros",
      strategyPreserve: "Manter",
      strategyStrip: "Remover",
      strategyCustom: "Personalizar",
      customParamsPlaceholder: "ex. (200) ou (10,2)",
      addMapping: "Adicionar mapeamento",
      removeMapping: "Remover",
      noMappings: "Nenhum mapeamento de tipo de campo definido",
      sameTypeHint: "Origem e destino são do mesmo tipo de banco — nenhum mapeamento necessário",
      preset: "Mapeamentos predefinidos",
      selectPreset: "Selecionar predefinido...",
      openFieldMapping: "Mapeamento de Tipo de Campo",
      import: "Importar",
      export: "Exportar",
      importSuccess: "Importado com sucesso",
      importError: "Falha na importação: arquivo não é um JSON de mapeamento de tipo de campo válido",
      done: "Concluir",
    },
    fieldMappingToggle: "Mapeamento de tipos de campo",
  },
  schemaDiff: {
