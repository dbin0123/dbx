...
export default withEnglishFallback({
  ...
  diff: {
    ...
    fieldMapping: {
      ...
      description: "Personalizar cómo se mapean los tipos de datos de origen a los de destino cuando las bases de datos difieren",
      sourceType: "Tipo origen",
      targetType: "Tipo destino",
      paramStrategy: "Parámetros",
      strategyPreserve: "Conservar",
      strategyStrip: "Eliminar",
      strategyCustom: "Personalizar",
      customParamsPlaceholder: "ej. (200) o (10,2)",
      addMapping: "Agregar mapeo",
      removeMapping: "Eliminar",
      noMappings: "No hay mapeos de tipo de campo definidos",
      sameTypeHint: "Origen y destino son del mismo tipo de base de datos — no se necesitan mapeos",
      preset: "Mapeos predefinidos",
      selectPreset: "Seleccionar predefinido...",
      openFieldMapping: "Mapeo de Tipo de Campo",
      import: "Importar",
      export: "Exportar",
      importSuccess: "Importado exitosamente",
      importError: "Error de importación: el archivo no es un JSON de mapeo de tipo de campo válido",
      done: "Hecho",
    },
    fieldMappingToggle: "Mapeo de tipos de campo",
  },
  schemaDiff: {
